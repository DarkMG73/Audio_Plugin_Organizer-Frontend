  ...
  useEffect(() => {
    if (sendToLibrary) {
      ...
      const toAddArrays = addToLibrary.map((name) => {
        ...
        outputArray[categoryTitles.indexOf('functions')] = '/Audio Effects/';
        ...
        <ul>
          ...
          {!user && findNewPlugins && (
            <div className={Styles['login-message-wrap']}>
              <p>
                Please log in to be able to search for plugins on your machine.
              </p>
              <p>
                If you do not have a profile, please register using the "Sign
                Up" button above.
              </p>
            </div>
          )}
          {user && findNewPlugins && (
            <Fragment>
              {fileNames.length > 0 && (
                <h3>{fileNames.length} new plugins found on this computer.</h3>
              )}
              ...
              {showHidePluginPathsButton && (
                ...
                >
                  {!showPluginPaths && !noPluginPathsExist && <span>Show</span>}
                  {(showPluginPaths || noPluginPathsExist) && <span>Hide</span>}
                  Plugin Paths
                </button>
              )}
              ...
              {!showHidePluginPathsButton && (
                <p>
                  * Please paste in the paths to each plugin location on your
                  system *
                </p>
              )}
              {(showPluginPaths || noPluginPathsExist) && (
                <div className={Styles['url-input-container']}>
                  <div className={Styles['location-input-container']}>
                    <label htmlFor="location-1">Plugin Location 1</label>
                    <input
                      name="location-1"
                      type="text"
                      defaultValue={
                  ...
                  <div className={Styles['location-input-container']}>
                    <label htmlFor="location-2">Plugin Location 2</label>
                    <input
                      name="location-2"
                      type="text"
                      defaultValue={
                  ...
                  <div className={Styles['location-input-container']}>
                    <label htmlFor="location-3">Plugin Location 3</label>
                    <input
                      name="location-3"
                      type="text"
                      defaultValue={
                  ...
                  <div className={Styles['location-input-container']}>
                    <label htmlFor="location-4">Plugin Location 4</label>
                    <input
                      name="location-4"
                      type="text"
                      defaultValue={
              ...
              <div className={Styles['ignore-plugin-list-container']}>
                ...
                {showSaveIgnoreListButton && (
                  <button
                    type="button"
                    className={
                      Styles.pulse + ' ' + Styles['button-action-needed']
                    }
                ...
                <ul>
                  {ignorePluginList.length <= 0 && (
                    <div className={Styles['plugin-finder-text-box']}>
                      <p>
                        Plugins to ignore will appear here. Click the X next to
                        the plugin name to ignore.
                        <br />
                        Be sure to save this list after each change.
                        <br />
                        Restore an ignored plugin anytime by clicking on it.
                      </p>
                    </div>
                  )}
              ...
              <div className={Styles['button-container']}>
                <label htmlFor="select-none" onClick={handleClearAllCheckBox}>
                ...
                {fileNames.length > 0 && (
                  <label htmlFor="select-all" onClick={handleCheckAllCheckBox}>
              ...
              >
                <p>
                  Click the plugin name to select it to add to the library.
                  Click the X to ignore it in the future.
                </p>
              </div>
              <button
                type="button"
                ...
                <li key={index}>
                  ...
                  >
                    <input
                      ...
                      name={fileName}
                      data-file-name={fileName}
                      defaultChecked={addToLibrary.includes(fileName)}
