...
const FormInput = (props) => {
  ...
  const handleOnSelectPic = (imageObj) => {
    ...
    setPhotoSelected(picLocation + groomedImageNameStart + groomedImageNameEnd);
  };
    ...
    const checkForElmInterval = setInterval(() => {
      ...
      if (imagePickerElm) {
        ...
        allElms.forEach((elm) => {
          ...
          newH3ELm.innerText = imageName.replace('_', ' ').replace('-', ' ');
  ...
  if (input.type === 'textarea') {
      ...
      >
        ...
        {requiredError && input.required == true && (
          <span
            key={'form-input-3'}
            className={
              styles[requiredClass + '-text'] + ' ' + requiredClass + '-text'
            }
          >
    ...
    outputJSX = (
      ...
      >
        ...
        <input
          ...
          name={formNumber + '#' + input.name}
          defaultValue={input.options[0].trim()}
          required={input.required}
          onChange={props.onChange || textInputOnChangeHandler}
        />
        <datalist
    ...
    outputJSX = (
      ...
      >
        <label key={'form-input-1t'} htmlFor={formNumber + '#' + input.name}>
          {input.title}
          {input.title === 'Producturl' && (
            ...
            >
              To get the product URL a photo URL, find the developer page here
              &rarr;
            </a>
          )}
        </label>
        ...
        {input.title === 'Photourl' && (
          ...
          >
            ...
            >
                ...
                >
                  ...
                  >
                    <button
                      ...
                      className={
                        styles['select-button'] + ' ' + 'select-button'
                      }
                    >
                      OK
                    </button>
                    <button
                      ...
                      onClick={handleClosePicSelector}
                      className={
                        styles['cancel-button'] + ' ' + 'cancel-button'
                      }
                    >
                      Cancel
                    </button>
              ...
              <button onClick={handleClosePicSelector} data-selector-type="oem">
